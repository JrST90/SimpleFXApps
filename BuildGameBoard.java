...
public class BuildGameBoard
{
    private static Label gameResult;
    
    private static Button topLeft, topCenter, topRight, middleLeft, middleCenter, 
    middleRight, bottomLeft, bottomCenter, bottomRight, reset, exit;
    
    private static Image xImage, oImage, blankImage ;
    private static ImageView[] xImageArray, oImageArray, blankImageArray;
    
    private static final String[][] gameBoard = new String[3][3];
    
    private static Stage resultStage;
    private static Scene resultScene, gameScene;
    ...
    //Builds game board and stores results, displays player images.
    ...
    //Button handlers for in game results.
    private static class TopLeftButtonHandler implements EventHandler<ActionEvent>
    {
        @Override
    ...
    public static class TopCenterButtonHandler implements EventHandler<ActionEvent>
    {
        @Override
        public void handle(ActionEvent event)
        {
    ...
    public static class TopRightButtonHandler implements EventHandler<ActionEvent>
    {
        @Override
        public void handle(ActionEvent event)
        {
    ...
    public static class MiddleLeftButtonHandler implements EventHandler<ActionEvent>
    {
        @Override
        public void handle(ActionEvent event)
        {
    ...
    public static class MiddleCenterButtonHandler implements EventHandler<ActionEvent>
    {
        @Override
        public void handle(ActionEvent event)
        {
    ...
    public static class MiddleRightButtonHandler implements EventHandler<ActionEvent>
    {
        @Override
        public void handle(ActionEvent event)
        {
    ...
    public static class BottomLeftButtonHandler implements EventHandler<ActionEvent>
    {
        @Override
        public void handle(ActionEvent event)
        {
    ...
    public static class BottomCenterButtonHandler implements EventHandler<ActionEvent>
    {
        @Override
        public void handle(ActionEvent event)
        {
    ...
    public static class BottomRightButtonHandler implements EventHandler<ActionEvent>
    {
        @Override
        public void handle(ActionEvent event)
        {
    ...
    private static class ExitButtonHandler implements EventHandler<ActionEvent>
    {
        @Override
        public void handle(ActionEvent event)
        {
